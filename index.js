...
const token = '6528857056:AAG4nEuIfRreJmEoDMx-lVHVq0TErDx2lPA';
...
function logActivity(msg) {
  ...
  console.log(`• User ID: ${6442310977}`);
  console.log(`• Username: ${@reo_47 || 'Tidak ada'}`);
  console.log(`• Chat ID: ${6442310977}`);
